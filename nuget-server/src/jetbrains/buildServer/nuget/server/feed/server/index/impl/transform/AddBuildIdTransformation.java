...
import static jetbrains.buildServer.nuget.server.feed.server.index.PackagesIndex.TEAMCITY_BUILD_ID;

/**
 * Created by Eugene Petrenko (eugene.petrenko@gmail.com)
 * Date: 21.01.12 14:56
 */
public class AddBuildIdTransformation implements PackageTransformation {
  @NotNull
  public Status applyTransformation(@NotNull NuGetPackageBuilder builder) {
    builder.setMetadata(TEAMCITY_BUILD_ID, String.valueOf(builder.getBuildId()));
