...
public class ThreadedBuildTriggetFactoryImpl implements ThreadedBuildTriggetFactory{
  ...
  public ThreadedBuildTriggetFactoryImpl(@NotNull final ExecutorServices executors) {
    myExecutors = executors;
  }

  public BuildTriggeringPolicy createTrigger(@NotNull TriggerUpdateChecker updateChecker) {
    return new ThreadedBuildTriggerPolicy(myExecutors.getLowPriorityExecutorService(), updateChecker);
  }
}
