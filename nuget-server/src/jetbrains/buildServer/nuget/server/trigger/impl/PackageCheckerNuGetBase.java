...
public class PackageCheckerNuGetBase {
  protected final NuGetToolManager myToolManager;

  public PackageCheckerNuGetBase(@NotNull final NuGetToolManager toolManager) {
  ...
  @Nullable
  protected File getNuGetPath(@NotNull PackageCheckRequest entry) {
