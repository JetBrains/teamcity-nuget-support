 ...
 * Date: 16.08.11 13:24
 */
public class ToolsWatcher {
  private static final Logger LOG = Logger.getInstance(ToolsWatcher.class.getName());
  ...
  public ToolsWatcher(@NotNull final ToolPaths paths,
    ...
    myWatcher.registerListener(new ChangeListener() {
      public void changeOccured(String requestor) {
        ToolsWatcher.this.onFilesChanged(
