...
*         Date: 17.07.12 12:30
*/
public class InstalledToolImpl implements InstalledTool {
  private static final Logger LOG = Logger.getInstance(InstalledToolImpl.class.getName());

  private final PluginNaming myNaming;
  private final File myPath;

  public InstalledToolImpl(@NotNull PluginNaming naming, @NotNull final File path) {
    myNaming = naming;
    myPath = path;
  }
