...
import jetbrains.buildServer.nuget.agent.runner.publish.PackRunnerStagesBuilder;
...
public class PackagesPublishIntegrationTest extends IntegrationTestBase {
  ...
  private void callPublishRunner(@NotNull final NuGet nuget, @NotNull final File pkg) throws RunBuildException {
    ...
    final PackagesPublishRunner runner = new PackagesPublishRunner(new PackRunnerStagesBuilder(new AuthStagesBuilder(myActionFactory), myActionFactory), myActionFactory, myParametersFactory);
